...
class __$$FieldChangedImplCopyWithImpl<$Res>
    extends _$ContactFormEventCopyWithImpl<$Res, _$FieldChangedImpl>
...
class _$FieldChangedImpl implements _FieldChanged {
  const _$FieldChangedImpl({required this.key, required this.value});
  ...
  @override
  String toString() {
    return 'ContactFormEvent.fieldChanged(key: $key, value: $value)';
  }
...
abstract class _FieldChanged implements ContactFormEvent {
...
class _$ContactFormStateImpl implements _ContactFormState {
  ...
  List<FormItemData> get formItems {
    if (_formItems is EqualUnmodifiableListView) return _formItems;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_formItems);
  }
